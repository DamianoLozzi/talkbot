...
class Filters():
    ...
    def filter_useful_messages(self,messages: List[TalkMessage]) -> List[TalkMessage]:
...
class Mappers():
    ...
    def talk_message_to_ollama_message(self,talk_message:TalkMessage,assistant_id:str)-> Message:
        ...
        return Message(
            role="assistant" if talk_message.actor_id == assistant_id else "user",
            content=content
        )